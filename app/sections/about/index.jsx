		...
		<LazyMotion features={domAnimation}>
			<section id="about" className="section">
				...
				<div className="pt-10 pb-16 max-w-5xl flex flex-col gap-3">
					...
					>
						<p>
							My name is Shahadath Hossain. I successfully graduated University of East London, Software Engineer, computer
							science faculty.
						</p>
						<p>
						...
						<p>So, officially, my programming journey began in 2017 as a web developer.</p>
						<p className="my-3.5">
							I enjoy learning technologies that interest me, which is why I dedicated a significant
							amount of time to working with Web based application.
						</p>
						<p>
						...
						<p className="my-3.5">
							In december 2023, I had an opportunity to start working as a Full Stuck developer for a
							company with the possibility of transitioning to web development. I was skeptical
							about it at first, but I decided to give it a try, and I don&lsquo;t regret it. Now, I
							thoroughly enjoy working with Laravel, React.js and Next.js.
						</p>
					</div>
				</div>
